  ...
  return (
    <NavigationContainer ref={navigationRef}>
      <Stack.Navigator initialRouteName="WelcomeScreen">
        ...
        <Stack.Screen name="ChoiceAddress" options={{ headerTitle: '' }} component={ChoiceAddress} />
        <Stack.Screen name="PaymentScreen" options={{ headerShown: false }} component={PaymentScreen} />
        <Stack.Screen name="ChoseScreen" options={{ headerShown: false }} component={ChoseScreen} />
        ...
        <Stack.Screen name="HTScreen" options={{ headerShown: false }} component={HTScreen} />
        ...
        <Stack.Screen name="OrderScreen" options={{ headerTitle: 'Đơn hàng', headerTitleAlign: 'center' }} component={OrderScreen} />
        ...
        />
        <Stack.Screen name="CartScreen" options={{ headerTitle: 'Giỏ hàng', headerTitleAlign: 'center' }} component={CartScreen} />
        <Stack.Screen name="SuccessScreen" options={{ headerShown: false }} component={SuccessScreen} />
        <Stack.Screen name="DaHuy" options={{ headerShown: false }} component={DaHuy} />
        <Stack.Screen name="DangChuanBiHang" options={{ headerShown: false }} component={DangChuanBiHang} />
        <Stack.Screen name="ChoThanhToan" options={{ headerShown: false }} component={ChoThanhToan} />
        <Stack.Screen name="ChoGiaoHang" options={{ headerShown: false }} component={ChoGiaoHang} />
        <Stack.Screen name="ChoXacNhan" options={{ headerShown: false }} component={ChoXacNhan} />
        <Stack.Screen name="DaGiaoHang" options={{ headerShown: false }} component={DaGiaoHang} />
        <Stack.Screen name="RatingScreen" options={{ headerShown: false }} component={RatingScreen} />
        <Stack.Screen name="FailedScreen" options={{ headerShown: false }} component={FailedScreen} />
        <Stack.Screen name="DetailOrderScreen" options={{ headerTitle: 'Chi tiết đơn hàng' }} component={DetailOrderScreen} />
        <Stack.Screen name="OrderRated" options={{ headerTitle: 'Sản phẩm đã đánh giá' }} component={OrderRated} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
