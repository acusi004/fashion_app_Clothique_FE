...
import { View, Text, TouchableOpacity, Image, StyleSheet, SafeAreaView, FlatList, Alert, Linking } from "react-native";
...
const CheckoutScreen = () => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <TouchableOpacity style={styles.backButton} onPress={() => navigation.replace("CartScreen")}>
